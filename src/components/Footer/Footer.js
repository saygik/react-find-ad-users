                        ...
                        <Grid container spacing={2}  className={classes.bottomBorder}>
                            <Grid item>
                                <Typography  variant="h2"  color="primary" >
                                    <Box width={1}  fontFamily="Monospace" fontSize={'1.8rem'} letterSpacing={3} mr={2}>
                            ...
                            <Grid item sm container  direction="column" justify="flex-start" alignItems="flex-start" >
                                ...
                                <Grid item xs={12} sm container  direction="row" justify="flex-start" alignItems="flex-start" >
                                    <Grid item style={{width: '30px', }}>
                                        {loadingProgress.peoples.loading && <LittleLoader size={13} className={classes.loader} style={{top: '37px', }}/>}
                                    </Grid>
                                    <Grid item >
                                        <Typography  variant="h2"  color="primary" >
                                ...
                                <Grid item xs={12} sm container  direction="row" justify="flex-start" alignItems="flex-start" >
                                    <Grid item style={{width: '30px', }}>
                                        {loadingProgress.soft.loading && <LittleLoader size={13} className={classes.loader} style={{top: '56px', }}/>}
                                    </Grid>
                                    <Grid item >
                                        <Typography  variant="h2"  color="primary" >
                                            <Box  fontSize={'1.2rem'}   letterSpacing={1}>
